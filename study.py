#program will be asked a question about a subject in chemisty 

#the program will output a summary 

#goal is dictionary and a program that ask questions to help the user study 

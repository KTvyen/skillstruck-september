...
if cookie_pick == "b":
    print("""
    ~ Alright in the last segment you chose option b!
    ~ Which is the Chocolate Chunk Cookie.
    ~ You have to find out the correct order of steps to make this cookie
    
    Here is the written recipe for this cookie -->
    The Chocolate Chunk Cookie is a classic cookie for a reason! It starts out with browned butter (2 sticks worth). While the butter browns get your sugars ready. You will need """)
